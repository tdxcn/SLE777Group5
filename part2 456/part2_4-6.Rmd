...
---
#introduction: using the code to solve the sequence analysis, codon usage,k-mer analysis.
...
```
#conclusion of part2Question4：we can see that the acetobacter Aceti sequence is much smaller than the E. coli sequence but mostly in 2000-4000, but acetobacter Aceti exist some in 8000 and the E. coli only have in 6000. 
#codon usage, use the code to uncode the codon and show the frequency for part4 5
```{r}
uco(cds_aceti[[2]])
uco(cds_ecoli[[2]])
...
```
#conclusion of part2Question5：The E. coli use more Coden, but the frequency does not show much difference, which means E. coli may express more complex protein. 
#k-mer for part4 6
```{r}
...
```
#conclusion of part2Question6：Two the most used are the same and have very relative frequency, the organisms share a set of codons, so there will be some similarities in the sequences of some of their genes. 





#part2Question4：we can see that the acetobacter Aceti sequence is much smaller than the E. coli sequence but mostly in 2000-4000, but acetobacter Aceti exist some in 8000 and the E. coli only have in 6000. 
#part2Question5：The E. coli use more Coden, but the frequency does not show much difference, which means E. coli may express more complex protein. 
#part2Question6：Two the most used are the same and have very relative frequency, the organisms share a set of codons, so there will be some similarities in the sequences of some of their genes. 
