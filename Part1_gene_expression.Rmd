...
hist(gene_expression$Mean_expression,#Making histogram plot using values in the "Mean_expression" column
     breaks = 100, #Adjusting the number of bin in the histogram to 100  
...
```
From the histogram, it can be observed that a majority of genes (around 55000) showed no mean gene expression
